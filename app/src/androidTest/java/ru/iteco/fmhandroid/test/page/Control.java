...
public class Control {
    Timeout timeoutEspresso = new Timeout();
    ...
    public Timeout.TimedViewInteraction newsRecyclerList = timeoutEspresso.onViewWithTimeout(10000, withId(R.id.news_list_recycler_view));
    public ViewInteraction ButtonAppearNews = onView(withId(R.id.view_news_item_image_view));
